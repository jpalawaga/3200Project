...
// Problem number: 4562 - Coverage
// Description: Find the line segments that are cover the path for each cell
// tower and then sort them and put the overlapping sections together in one
// path then sum up the total and find the percent
//*****************************************************************************
